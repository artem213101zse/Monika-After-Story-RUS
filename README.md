...
# Внимание
Я не являюсь автором этого мода. Прочитайте [здесь](#информация-от-переводчика) для более подробной информации
...
Этот порт **Monika After Story** находится в стадии активной разработки. Планируется полный перевод на русский язык и адаптация всех встроенных игр (шахматы, пианино, виселица и другие) для платформы Android с поддержкой сенсорного управления. На данный момент перевод и адаптация игр частично реализованы, но работа продолжается по мере наличия времени и вдохновения, поэтому обновления будут выходить нерегулярно.

Порт создан на основе [официального репозитория Monika After Story](https://github.com/Monika-After-Story/MonikaModDev) и использует [Ren'Py 6.99.12.4.2187](https://www.renpy.org/release/6.99.12) для обеспечения совместимости. В будущем планиурется завершить перевод всех диалогов, полностью адаптировать игру для Android и Windows, улучшить интерфейс для сенсорных экранов, а так же перейти на более новую версию Ren'Py 7 для улучшения совместимости с новыми версиями Android

**Хотите помочь с переводом или разработкой?** Присоединяйтесь к проекту на [GitHub](https://github.com/artem213101zse/Monika-After-Story-RUS)! Вы можете предложить свои переводы, исправить баги или добавить новые функции. Инструкции по участию и шаблоны для переводов доступны в репозитории. Вместе мы сделаем этот порт ещё лучше!

Если вы обнаружите ошибки или хотите поделиться идеями, создайте issue на GitHub. Спасибо за поддержку и интерес к проекту!
